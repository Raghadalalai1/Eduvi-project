    ...
    <>
      <section className='LK-home-section3'>
        <div className='LK-home-section3-son1'>
          ...
          <h2 className='LK-home-sec3-son1-h2'>Qualified lessons for students</h2>
          <p className='LK-home-sec3-son1-par'>A lesson or class is a structured period of time where learning is intended to occur. It involves one or more students being taught by a teacher or instructor.</p>
